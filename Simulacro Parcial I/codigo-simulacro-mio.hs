...
tests = test [
    ...
    " relacionesValidas: una sola repetida" ~: (relacionesValidas [relacion1_1]) ~?= False,
    " relacionesValidas: una sola al reves" ~: (relacionesValidas [relacion1_2, relacion2_1]) ~?= False,
